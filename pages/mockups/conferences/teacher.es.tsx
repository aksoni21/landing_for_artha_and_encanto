...
export default function TeacherConferenceMockupES() {
  ...
  // Demo students fallback data (Spanish version)
  const demoStudents: Student[] = [
    { id: 'demo-1', name: 'Roberto González', email: 'roberto@demo.com', status: 'Activo', progress: 78, avgScore: 82, toefl: 65, weeklyMinutes: 45, lastActivity: '2025-03-20', storiesCompleted: 8, strugglingWith: 'Pretérito vs Imperfecto', strength: 'Retención de vocabulario' },
    { id: 'demo-2', name: 'Jessica Thompson', email: 'jessica@demo.com', status: 'Activo', progress: 45, avgScore: 65, toefl: 95, weeklyMinutes: 28, lastActivity: '2025-03-18', storiesCompleted: 3, strugglingWith: 'Subjuntivo', strength: 'Vocabulario básico' },
    { id: 'demo-3', name: 'Li Wei', email: 'liwei@demo.com', status: 'En Riesgo', progress: 85, avgScore: 88, toefl: 85, weeklyMinutes: 52, lastActivity: '2025-03-21', storiesCompleted: 12, strugglingWith: 'Ser vs Estar', strength: 'Pronunciación' },
    { id: 'demo-4', name: 'Ana Silva', email: 'ana@demo.com', status: 'Activo', progress: 92, avgScore: 90, toefl: 95, weeklyMinutes: 12, lastActivity: '2025-03-21', storiesCompleted: 15, strugglingWith: 'Por vs Para', strength: 'Fluidez conversacional' },
    { id: 'demo-6', name: 'Michael Johnson', email: 'michael@demo.com', status: 'En Riesgo', progress: 38, avgScore: 58, toefl: 82, weeklyMinutes: 18, lastActivity: '2025-03-15', storiesCompleted: 2, strugglingWith: 'Verbos irregulares', strength: 'Escritura' },
    { id: 'demo-7', name: 'Fatima Hassan', email: 'fatima@demo.com', status: 'Activo', progress: 72, avgScore: 79, toefl: 48, weeklyMinutes: 48, lastActivity: '2025-03-19', storiesCompleted: 9, strugglingWith: 'Comprensión auditiva', strength: 'Gramática' },
    { id: 'demo-9', name: 'Pierre Dubois', email: 'pierre@demo.com', status: 'Activo', progress: 18, avgScore: 75, toefl: 62, weeklyMinutes: 42, lastActivity: '2025-03-18', storiesCompleted: 7, strugglingWith: 'Pronunciación de R', strength: 'Vocabulario amplio' },
  ];
  ...
  const handleAIChatSend = () => {
    ...
    setTimeout(() => {
      const aiMessage: ChatMessage = {
        sender: 'ai',
        text: 'Basado en los datos, recomiendo enfocarse en estudiantes con participación decreciente. Roberto y Li Wei necesitan atención esta semana.',
        followup: ['Muéstrame estudiantes en riesgo', '¿Qué tareas debo asignar?', 'Generar reporte semanal']
      };
    ...
    switch (snapshotDetailsType) {
      case 'active':
        return {
          ...
          icon: '🟢',
          students: students.filter(s => s.status === 'Activo')
        };
      case 'at_risk':
        return {
          title: 'Estudiantes en Riesgo',
          icon: '⚠️',
          students: students.filter(s => s.status === 'En Riesgo')
        };
      case 'stories':
        return {
          title: 'Historias Leídas Hoy',
          icon: '📚',
          assignments: demoAssignments.filter(a => a.assignment_type === 'story')
        };
      case 'vocabulary':
        return {
          title: 'Práctica de Vocabulario Hoy',
          icon: '📖',
      ...
      case 'in_progress':
        return {
          title: 'Estudiantes con Historias en Progreso',
          icon: '⏳',
        ...
        <div className="mb-6">
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-gray-600">Tu centro de comando unificado</p>
            </div>
        ...
        <div className="mb-6">
          <div className="flex space-x-1 bg-white rounded-lg p-1 shadow">
            {[
              ...
              { key: 'insights', label: 'Perspectivas' }
            ].map(tab => (
              <button
                key={tab.key}
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
            ...
            >
              ...
              <div className="text-xs text-gray-500">🟢 Estudiantes Activos</div>
            </div>
            <div
            ...
            >
              ...
              <div className="text-xs text-gray-500">📚 Historias Leídas</div>
            </div>
            <div
            ...
            >
              ...
              <div className="text-xs text-gray-500">⚠️ En Riesgo</div>
            </div>
            <div
            ...
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600">Lo que necesita tu atención ahora</p>
                </div>
            ...
            <div className="p-6">
              {demoAlerts.length === 0 ? (
                <p className="text-gray-500 text-center py-8">
                  🎉 ¡Excelente! No hay alertas en este momento.
                </p>
              ) : (
            ...
            >
              ...
              <div className="mb-6 flex items-center justify-between">
                <div className="inline-flex items-center px-3 py-1 bg-yellow-100 text-yellow-800 rounded-full text-xs font-semibold">
                  📊 MODO DEMO - Usando datos de tareas de demostración
                </div>
                <button
              ...
              <div className="bg-white rounded-lg shadow p-6 mb-6">
                <h3 className="text-lg font-semibold mb-4">Weekly Assignments Trends</h3>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                {demoAssignments.map(assignment => (
                  <div key={assignment.id} className="flex items-start p-3 hover:bg-gray-50 rounded-lg mb-2 cursor-pointer" onClick={() => navigateToStudent(assignment.student_id)}>
                    <span className="text-2xl mr-3">{getActivityIcon(assignment.assignment_type)}</span>
                    <div className="flex-1">
                      <div className="font-medium text-gray-900">{assignment.student_name}</div>
                      <div className="text-sm text-gray-600">{assignment.topic}</div>
                      {assignment.note !== undefined && (
                        <span className={`text-sm font-medium ${
                          Number(assignment.note) >= 80 ? 'text-green-600' : Number(assignment.note) >= 60 ? 'text-yellow-600' : 'text-red-600'
                        }`}>
                          {Number(assignment.note)}% score
                        </span>
                      )}
